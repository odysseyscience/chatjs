...
var $ = require('jquery'),
    ServerTypes = require('./jquery.chatjs.adapter.servertypes'),
    ChatUserInfo = ServerTypes.ChatUserInfo,
    ChatRoomInfo = ServerTypes.ChatRoomInfo,
    ChatMessageInfo = ServerTypes.ChatMessageInfo,
    ChatUserListChangedInfo = ServerTypes.ChatUserListChangedInfo,
    ChatTypingSignalInfo = ServerTypes.ChatTypingSignalInfo;
